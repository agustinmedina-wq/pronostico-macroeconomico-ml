...
Trabajo de portafolio semestral — Ciencia de Datos para la Economía, Ingeniería Comercial (UDP).
...
Este proyecto compara distintos modelos de Machine Learning aplicados al pronóstico
de variables macroeconómicas de Estados Unidos, usando la base de datos **FRED-MD**
(McCracken & Ng, 2016).
...
modelo adicional no considerado por los autores: **XGBoost**, para evaluar si el
boosting secuencial aporta ventajas sobre el bagging del Random Forest.
...
[Google Colab](https://colab.research.google.com/) y ejecutar todas las celdas en orden
(`Entorno de ejecución → Ejecutar todas`). El notebook instala automáticamente las
